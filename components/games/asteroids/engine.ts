...
// Port de references/templates/started-games/02-asteroids/game.js: misma lógica
...
// ── Factory ───────────────────────────────────────────────────────────────────
export function createAsteroidsEngine(canvas: HTMLCanvasElement): AsteroidsEngine {
  ...
  const TRACKED_CODES = new Set(["ArrowLeft", "ArrowRight", "ArrowUp", "Space"]);
